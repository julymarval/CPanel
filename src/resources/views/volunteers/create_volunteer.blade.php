                ...
                <div class="row vertical-offset-100">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            ...
                            <h3 class="panel-title" style="text-align: center">Add new Volunteer</h3>
                        </div>
                        <div class="panel-body">
                            <form id="check" method="POST" enctype="multipart/form-data" action="{{route('volunteers.store')}}">  
                                <fieldset>
                                    ...
                                    <div class="form-group has-feedback">
                                        <input type="file" id="fileupload" name="photos[]" data-url="/uploadvolunteer" multiple />
                                    </div>
                                    <br>
