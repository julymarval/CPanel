...
<div class="jumbotron text-center">
  ...
  <br>
  <br>
  <a href="http://streamdb6web.securenetsystems.net/v5/WSBL" target="_blank"><button type="button" class="btn">EN VIVO</button></a>
...
<div id="about" class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-8">
        <h4>Mission</h4>
        <p> Servir a la comunidad hispana del condado de San Jose, Indiana y sus alrededores proveyendo por medio del formato de la radio informacion, motivacion y educacion social. Proporcionar ayuda financiera mediante la distribucion de fondos destinados a estudiantes para becase universitarias.</p>
        <br>       
    </div>
  </div>
