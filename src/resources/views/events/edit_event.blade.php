                ...
                <form id="check" method="POST" enctype="multipart/form-data" action="{{route('events.update', $event -> id)}}">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            {!! Form::select('volunteer_id',$volunteers,$event -> volunteers ,['volunteers' => 'id', 'class' => 'form-control',
                            'single',null]) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('sponsors', 'Sponsors') !!}
                            {!! Form::select('sponsor_id',$sponsors,$event -> sponsors,['sponsors' => 'id', 'class' => 'form-control',
                            'single',null]) !!}
                        </div>
                        <br>
